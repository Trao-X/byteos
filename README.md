...
<br><br>
you need a board with the STM32C031F6P6 mcu to use byteos, or you can use renode
<br><br>
...
<br>br>
or you can always just use `make` as now we have a makefile
<br><br>
beautiful commands!
<br><br>
...
<br><br>
licenses used: MIT (byteos, embedded artistry's strcmp), CC-BY-SA 3.0 (wagiminators/Stefan Wagners board)
<br>
warning this board has not been made yet and the firmware wasnt tested on real hardware only in renode
