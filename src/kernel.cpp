...
uart_init();
uartcharacterplacement("welcome to byteos 1.1.2 designed for byte dev board\r\n");
while (1) {
    startanewterm();
    typepls();
...
// the while(1) part is entirely copied because i do not understand c // this is not true anymore!
