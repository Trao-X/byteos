...
byteos is a c++ aarch64 os started yesterday! it utilizes uart so far, what it does not do is utilize the other shit on the board i made (in the hardware folder)
...
credits to: wagiminator for his original board that i based my board off because i have no fucking idea how designing pcbs work and the osdev wiki it really helped me and credits to the person who made the linker that i forgot the name of
